...
CREATE TABLE `course` (
  ...
  CONSTRAINT `co_cs_schedule_num` FOREIGN KEY (`co_cs_schedule_num`) REFERENCES `course_scedule` (`cs_scedule_num`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
INSERT INTO `member` VALUES ('abcd','1234','안건우','1993-01-13','010-3151-7063','남',10,'건우','서울시 은평구 가좌로 165','서울시 은평구 갈현동 662','오벨리스크 401호',100,NULL,NULL,'zkoiu@naver.com');
...
INSERT INTO `member_profile` VALUES (2,'/2023/04/16/1fbef0fe-7aa1-4c35-933d-03704ce66729_더미1.jpg','더미1.jpg','abcd');
...
INSERT INTO `product` VALUES (1,'여행지','<p>여행지<br></p>','여행지','여행지','여행지','여행지','여행지',111,1,'01:30:00','01:00:00',1),(2,'숙박','<p>숙박<br></p>','숙박','숙박','숙박','숙박','숙박',1,1,'00:30:00','00:00:00',3);
...
-- Dump completed on 2023-04-16 23:58:37
